  ...
  return (
    <div className={`pt-2 pb-3 ${paddingClass} cursor-pointer group`}>
      <div className="relative flex items-center gap-3 overflow-hidden py-5 rounded-full w-full">
        ...
        <div className="ml-4 relative overflow-hidden w-10 flex-shrink-0" style={{ height: '1em', fontSize: '45px' }}>
          <span className="absolute inset-0 flex items-center justify-center text-white font-semibold translate-y-full group-hover:translate-y-0 transition-transform duration-500 ease-[cubic-bezier(0.2,0.9,0.4,1.1)]" style={{ fontSize: '45px' }}>
            ↗
          </span>
        </div>
